...
const DescriptionBlock = () => {
  ...
  return (
    <section className="description-block">
      ...
      >
        <h2 className="description-block__header-text" id="WhoAmI">
          Who Am I
        </h2>
        <img
          src={question}
          alt="Question"
          className="description-block__header-logo"
        />
      </div>
      <div
        data-aos="zoom-in"
        data-aos-delay="100"
        data-aos-once="true"
        className="description-block__description"
      >
        ...
        <div
          ...
          data-aos-delay="100"
          data-aos-once="true"
          className="description-block__content-part"
        >
          <div className="description-block__text">
            Hello, my name is{" "}
            <a
              href="https://linkedin.com/in/vladJ1"
              target="_blank"
              rel="noreferrer"
              className="description-block__link"
            >
              Vlad
            </a>
          ...
          <div className="description-block__text">
            ...
            favourites! And I also like to talk with people, so feel free to{" "}
            <a
          ...
          <button
            className="description-block__hello-button"
            type="button"
