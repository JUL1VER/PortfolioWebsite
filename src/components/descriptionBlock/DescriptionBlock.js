        ...
        <div className='DescriptionBlock_wrapper'>
            ...
            <div data-aos='zoom-in' data-aos-delay='400' data-aos-once='true' className='DescriptionBlock_description'>
                ...
                <div data-aos='fade-up' data-aos-delay='400' data-aos-once='true' className="DescriptionBlock_contentPart">
                    <div className='DescriptionBlock_text'>Hello, my name is <GlitchText component="a" onHover={true} color1='rgba(212, 81, 25, 0.7)' color2='rgba(25, 100, 212, 0.7)' href="https://linkedin.com/in/vladJ1" target='_blank' rel='noreferrer' className='DescriptionBlock_link'>Vlad</GlitchText> and I like to create cool things! Interesting fact about me: just like I'm obsessed with programming, I love to write <GlitchText component="a" onHover={true} color1='rgba(212, 81, 25, 0.7)' color2='rgba(25, 100, 212, 0.7)' href="https://stihi.ru/avtor/jul1ver" target='_blank' rel='noreferrer' className='DescriptionBlock_link'>poems</GlitchText>. That's why I can say programming is a poetry too!</div>
                    <div className='DescriptionBlock_text'>Currently I'm developing well desingned impressive apps in <GlitchText component="a" onHover={true} color1='rgba(212, 81, 25, 0.7)' color2='rgba(25, 100, 212, 0.7)' href="https://mish.design/" target='_blank' rel='noreferrer' className='DescriptionBlock_link'>Mish.design</GlitchText>. Mostly I work using React and TypeScript, but I also like native JavaScript. The power and possibilities of CSS never stop to amaze me!</div>
                    <div className='DescriptionBlock_text'>I am interested in many things including science, poetry, music, history, phylosophy and travelling. But programming is one of my favourites! And I also like to talk with people, so feel free to <GlitchText component="a" onHover={true} color1='rgba(212, 81, 25, 0.7)' color2='rgba(25, 100, 212, 0.7)' href="mailto:jul1v3r@gmail.com" target='_blank' rel='noreferrer' className='DescriptionBlock_link'>say</GlitchText> me something :)</div>
